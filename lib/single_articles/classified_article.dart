...
class ClassifiedArticle extends StatefulWidget {
  final dynamic article;
  final String heroId;

  ClassifiedArticle(this.article, this.heroId, {Key key}) : super(key: key);

  @override
  _ClassifiedArticleState createState() => _ClassifiedArticleState();
}

class _ClassifiedArticleState extends State<ClassifiedArticle> {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ClassifiedArticle(item, heroId),
                        ),
                      );
                    },
