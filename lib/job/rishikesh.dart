...
class RishikeshJobArticles extends StatefulWidget {
  @override
  _RishikeshJobArticlesState createState() => _RishikeshJobArticlesState();
}

class _RishikeshJobArticlesState extends State<RishikeshJobArticles> {
