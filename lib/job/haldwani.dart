...
class HaldwaniJobArticles extends StatefulWidget {
  @override
  _HaldwaniJobArticlesState createState() => _HaldwaniJobArticlesState();
}

class _HaldwaniJobArticlesState extends State<HaldwaniJobArticles> {
