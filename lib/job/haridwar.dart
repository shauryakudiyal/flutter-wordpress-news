...
class HaridwarJobArticles extends StatefulWidget {
  @override
  _HaridwarJobArticlesState createState() => _HaridwarJobArticlesState();
}

class _HaridwarJobArticlesState extends State<HaridwarJobArticles> {
