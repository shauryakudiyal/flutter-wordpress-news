...
class RishikeshClassified extends StatefulWidget {

  RishikeshClassified(this.colorVal);
  int colorVal;

  _RishikeshClassifiedState createState() => _RishikeshClassifiedState();
}

class _RishikeshClassifiedState extends State<RishikeshClassified> with SingleTickerProviderStateMixin{
