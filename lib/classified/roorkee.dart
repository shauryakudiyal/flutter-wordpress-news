...
class RoorkeeClassified extends StatefulWidget {

  RoorkeeClassified(this.colorVal);
  int colorVal;

  _RoorkeeClassifiedState createState() => _RoorkeeClassifiedState();
}

class _RoorkeeClassifiedState extends State<RoorkeeClassified> with SingleTickerProviderStateMixin{
