...
class HaridwarClassified extends StatefulWidget {

  HaridwarClassified(this.colorVal);
  int colorVal;

  _HaridwarClassifiedState createState() => _HaridwarClassifiedState();
}

class _HaridwarClassifiedState extends State<HaridwarClassified> with SingleTickerProviderStateMixin{
