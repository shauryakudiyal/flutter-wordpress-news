...
class HaldwaniClassified extends StatefulWidget {

  HaldwaniClassified(this.colorVal);
  int colorVal;

  _HaldwaniClassifiedState createState() => _HaldwaniClassifiedState();
}

class _HaldwaniClassifiedState extends State<HaldwaniClassified> with SingleTickerProviderStateMixin{
